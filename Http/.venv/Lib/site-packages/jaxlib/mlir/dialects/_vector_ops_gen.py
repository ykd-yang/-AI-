...
def from_elements(dest, elements, *, loc=None, ip=None) -> _ods_ir.Value:
...
def load(result, base, indices, *, nontemporal=None, alignment=None, loc=None, ip=None) -> _ods_ir.Value:
...
def maskedload(result, base, indices, mask, pass_thru, *, alignment=None, loc=None, ip=None) -> _ods_ir.Value:
...
def maskedstore(base, indices, mask, value_to_store, *, alignment=None, loc=None, ip=None) -> _ods_ir.Operation:
...
def scalable_extract(result, source, pos, *, loc=None, ip=None) -> _ods_ir.Value:
...
def store(value_to_store, base, indices, *, nontemporal=None, alignment=None, loc=None, ip=None) -> _ods_ir.Operation:
...
class ToElementsOp(_ods_ir.OpView):
  ...
  def __init__(self, elements, source, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def to_elements(elements, source, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ToElementsOp(elements=elements, source=source, loc=loc, ip=ip))
