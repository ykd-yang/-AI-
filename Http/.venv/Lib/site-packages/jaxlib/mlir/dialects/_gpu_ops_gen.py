...
class GPUFuncOp(_ods_ir.OpView):
  ...
  def __init__(self, function_type, *, arg_attrs=None, res_attrs=None, workgroup_attrib_attrs=None, private_attrib_attrs=None, known_block_size=None, known_grid_size=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_625')) else
      _ods_ir.AttrBuilder.get('anonymous_625')(function_type, context=_ods_context))
...
class RotateOp(_ods_ir.OpView):
  ...
  def __init__(self, value, offset, width, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def rotate(value, offset, width, *, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return RotateOp(value=value, offset=offset, width=width, loc=loc, ip=ip).results
