...
class LoadOp(_ods_ir.OpView):
  ...
  def __init__(self, memref, indices, *, nontemporal=None, alignment=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def load(memref, indices, *, nontemporal=None, alignment=None, loc=None, ip=None) -> _ods_ir.Value:
  return LoadOp(memref=memref, indices=indices, nontemporal=nontemporal, alignment=alignment, loc=loc, ip=ip).result
...
def store(value, memref, indices, *, nontemporal=None, alignment=None, loc=None, ip=None) -> _ods_ir.Operation:
